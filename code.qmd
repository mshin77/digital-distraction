...
The website contains outputs and code used to analyze numeric and ordinal data in Park et al. (in press). Reproducible materials are also posted at the [Github](https://github.com/mshin77/digital-distraction). 
