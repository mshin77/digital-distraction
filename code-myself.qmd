...
data <- read_excel("data/merged_df.xlsx")
...
print(docx, target = "results/demo_tbl.docx")
```
...
htmlreg(list(main.AI1, main.AI2, main.AI3, main.AI4, main.AI5), file="results/main.AI.docx", 
        single.row = TRUE, 
        doctype = TRUE,    
        inline.css = TRUE,
        html.tag = TRUE,   
        ...
        body.tag = TRUE,   
        table.tag = TRUE,  
        caption = "Comparison of Models for AI") 
```
...
htmlreg(list(main.OV1, main.OV2, main.OV3), file="results/main.OV.docx", 
        single.row = TRUE, 
        doctype = TRUE,    
        inline.css = TRUE,
        html.tag = TRUE,   
        ...
        body.tag = TRUE,   
        table.tag = TRUE,  
        caption = "Comparison of Models for OV") 
```
## MT
...
htmlreg(list(main.MT1, main.MT2, main.MT3, main.MT4), file="results/main.MT.docx", 
        single.row = TRUE, 
        doctype = TRUE,    
        inline.css = TRUE,
        html.tag = TRUE,   
        ...
        body.tag = TRUE,   
        table.tag = TRUE,  
        caption = "Comparison of Models for MT") 
```
...
htmlreg(list(main.ER1, main.ER2, main.ER3, main.ER4), file="results/main.ER.docx", 
        single.row = TRUE, 
        doctype = TRUE,    
        inline.css = TRUE,
        html.tag = TRUE,   
        ...
        body.tag = TRUE,   
        table.tag = TRUE,  
        caption = "Comparison of Models for ER") 
```

## Social Validity

```{r}
selected_df <- data %>% filter(time == "1" & group == "1") %>%
  select(Q1:Q7) %>% mutate(across(everything(), as.factor))

levels <- function(df) {
  all_levels <- c("Strongly disagree", "Disagree", "Neutral", "Agree", "Strongly agree")
...
plot(likert(selected_df[,c(1:7)]), legend.position="right") + theme_minimal(base_size = 14) +
    theme(
  ...
  scale_fill_brewer(palette = "YlGnBu", breaks = c("Strongly disagree", "Disagree", "Neutral", "Agree", "Strongly agree"))
...
list <- c("demo_tbl_ft", "main.AI1", "main.AI2", "main.AI3", "main.AI4", "main.AI5", 
          "main.OV1", "main.OV2", "main.OV3", 
          "main.MT1", "main.MT2", "main.MT3", "main.MT4", 
          "main.ER1", "main.ER2", "main.ER3", "main.ER4")

save(list = list, file = "data/digital_distraction_data.RData")
```
